...
our %config = (
    ...
    "perlargv" => [
        ...
        "mingw",
        "no-shared",
        "--prefix=/workspaces/tdlib-purple/deps/win32-dev/openssl"
    ],
    "perlenv" => {
        "AR" => undef,
        "ARFLAGS" => undef,
...
unless (caller) {
    ...
    use lib '/workspaces/tdlib-purple/deps/openssl-3.0.13/util/perl';
    use OpenSSL::fallback '/workspaces/tdlib-purple/deps/openssl-3.0.13/external/perl/MODULES.txt';
    ...
    if (scalar @ARGV == 0) {
        ...
        use lib '.';
        use lib '/workspaces/tdlib-purple/deps/openssl-3.0.13/Configurations';
        use gentemplate;
