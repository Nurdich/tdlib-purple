...
BEGIN {
    ...
    require '/workspaces/tdlib-purple/deps/openssl-3.0.13/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/workspaces/tdlib-purple/deps/openssl-3.0.13/test/fips-and-base.cnf';
    shift;
